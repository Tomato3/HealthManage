...
import com.example.healthmanage.view.TipToast;
...
//            progressDlg.show();
    ...
    public static void showTipDialog(Context context, int icon, String message) {
        TipToast tipToast = new TipToast(context, icon, message);
        tipToast.show();
    }
