...
public class AirTaskAdapter extends BaseQuickAdapter<HealthTaskDetailResponse.DataBean.SongARIListBean, BaseViewHolder> {
    public AirTaskAdapter(@Nullable List<HealthTaskDetailResponse.DataBean.SongARIListBean> data) {
        super(R.layout.item_vip_detail,data);
    }

    @Override
    protected void convert(BaseViewHolder helper, HealthTaskDetailResponse.DataBean.SongARIListBean item) {
