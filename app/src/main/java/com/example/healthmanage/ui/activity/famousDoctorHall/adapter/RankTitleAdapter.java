 ...
 * author:bWang
 */
public class RankTitleAdapter extends BaseQuickAdapter<RankTitleBean, BaseViewHolder> {
    private Context mContext;
    public RankTitleAdapter(@Nullable List<RankTitleBean> data,Context context) {
        super(R.layout.item_select_office,data);
        this.mContext = context;
    }

    @Override
    protected void convert(BaseViewHolder helper, RankTitleBean item) {
