...
public class BusinessPicAdapter extends BaseQuickAdapter<BusinessDetailResponse.DataBean.ListBean, BaseViewHolder> {
    private Context context;
    public BusinessPicAdapter(Context context,@Nullable List<BusinessDetailResponse.DataBean.ListBean> data) {
        super(R.layout.item_patient_picture,data);
        this.context = context;
    }

    @Override
    protected void convert(BaseViewHolder helper, BusinessDetailResponse.DataBean.ListBean item) {
