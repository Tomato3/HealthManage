...
public class SpiritAdapter extends BaseQuickAdapter<SpiritHealthResponse.DataBean, BaseViewHolder> {
    private List<HeartRateBean> heartRateBeanList;
    private List<BreathRateBean> breathRateBeanList;
    public SpiritAdapter(@Nullable List<SpiritHealthResponse.DataBean> data) {
        super(R.layout.item_spirit_health, data);
    }

    @Override
    protected void convert(BaseViewHolder helper, SpiritHealthResponse.DataBean item) {
        ...
        List<SpiritHealthResponse.DataBean.HeartRateBean> list = item.getHeartRate();
        List<String> times = new ArrayList<>();
//        List<String> breathTimes = new ArrayList<>();
        for (SpiritHealthResponse.DataBean.HeartRateBean heartBean : list) {
