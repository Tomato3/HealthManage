...
public class GridPicAdapter extends BaseQuickAdapter<CheckReportResponse.DataBean.AppUserReportListBean, BaseViewHolder> {
    private Context mContext;
    public GridPicAdapter(Context context, @Nullable List<CheckReportResponse.DataBean.AppUserReportListBean> data) {
        super(R.layout.item_report_pic,data);
        this.mContext = context;
    }

    @Override
    protected void convert(BaseViewHolder helper, CheckReportResponse.DataBean.AppUserReportListBean item) {
        if (item.getUrl()!=null){
