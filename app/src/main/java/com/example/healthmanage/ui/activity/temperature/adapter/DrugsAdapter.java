...
public class DrugsAdapter extends BaseQuickAdapter<PrescriptionResponse.DataBean.DrugListBean, BaseViewHolder> {
    public DrugsAdapter(@Nullable List<PrescriptionResponse.DataBean.DrugListBean> data) {
        super(R.layout.item_prescription_model_detail,data);
    }
    ...
    protected void convert(BaseViewHolder helper, PrescriptionResponse.DataBean.DrugListBean item) {
        ...
        helper.setText(R.id.tv_drugs_num_type,item.getUnit());
