...
import com.example.healthmanage.databinding.ActivityTeamManageBinding;
 ...
 * 团队管理
 */
public class TeamActivity extends BaseActivity<ActivityTeamManageBinding,TeamViewModel> implements TitleToolBar.OnTitleIconClickCallBack, View.OnClickListener{
    ...
    protected void initData() {
        ...
        teamMemberAdapter = new TeamMemberAdapter(TeamActivity.this,doctorBeans);
            ...
            public void onItemChildClick(BaseQuickAdapter adapter, View view, int position) {
                switch (view.getId()){
                    case R.id.tv_more_detail:
                        ...
                        intent.putExtra("dataBean",doctorBeans.get(position));
