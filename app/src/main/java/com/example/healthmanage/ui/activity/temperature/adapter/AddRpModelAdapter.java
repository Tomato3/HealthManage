...
public class AddRpModelAdapter extends RecyclerView.Adapter<AddRpModelAdapter.ViewHolder> {
    private AppCompatActivity context;
    private OnListRemovedListener mListener;
    public List<InsertPrescriptionBean.DrugListBean> list = new ArrayList<>();
    ...
    public AddRpModelAdapter(AppCompatActivity context, List<InsertPrescriptionBean.DrugListBean> list) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        if (viewType == NORMAL_VIEW){
            View view = LayoutInflater.from(context).inflate(R.layout.item_add_prescription,parent,false);
            return new AddRpModelAdapter.ViewHolder(view,viewType);
        }else {
            View footView = LayoutInflater.from(context).inflate(R.layout.footview,parent,false);
            return new AddRpModelAdapter.ViewHolder(footView,viewType);
        }
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        if (getItemViewType(position) == NORMAL_VIEW){
            ...
            holder.editDrugName.addTextChangedListener(new MyTextWatcher(holder) {
                @Override
                public void afterTextChanged(Editable s, AddRpModelAdapter.ViewHolder holder) {
                    int position = (int) holder.editDrugName.getTag();
                    InsertPrescriptionBean.DrugListBean prescriptionBean = list.get(position);
            ...
            InsertPrescriptionBean.DrugListBean prescriptionBean = list.get(typeTag);
            ...
            InsertPrescriptionBean.DrugListBean prescriptionBean1 = list.get(typeTag);
            ...
            InsertPrescriptionBean.DrugListBean prescriptionBean2 = list.get(timeTag);
            ...
            InsertPrescriptionBean.DrugListBean prescriptionBean3 = list.get(rateTag);
            ...
            holder.footView.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    list.add(new InsertPrescriptionBean.DrugListBean("盒","口服","睡前","一天三次"));
    ...
    public void addItem(int position, InsertPrescriptionBean.DrugListBean element) {
        if (position >= 0) {
            //给adapter里面的数据集合添加元素
        ...
        if (type==0){
            ...
            popAdapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
                ...
                public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                    ...
                    InsertPrescriptionBean.DrugListBean prescriptionBean = list.get(tag);
            ...
            popAdapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
                ...
                public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                    ...
                    oldPosition = position;
                    int tag = (int) holder.tvChooseTakeMethod.getTag();
            ...
            popAdapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
                ...
                public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                    ...
                    oldPosition = position;
                    int tag = (int) holder.tvChooseTakeTime.getTag();
                    numType = times.get(position).getName();
                    holder.tvChooseTakeTime.setText(numType);
                    InsertPrescriptionBean.DrugListBean prescriptionBean = list.get(tag);
            ...
            popAdapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
                ...
                public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                    ...
                    oldPosition = position;
                    int tag = (int) holder.tvChooseTakeRate.getTag();
                    numType = frequency.get(position).getName();
                    holder.tvChooseTakeRate.setText(numType);
                    InsertPrescriptionBean.DrugListBean prescriptionBean = list.get(tag);
    ...
    public void addData(InsertPrescriptionBean.DrugListBean prescriptionBean){
    ...
    private abstract class MyTextWatcher implements TextWatcher {
        private AddRpModelAdapter.ViewHolder mHolder;

        public MyTextWatcher(AddRpModelAdapter.ViewHolder holder) {
            this.mHolder=holder;
        }
        ...
        public abstract void afterTextChanged(Editable s, AddRpModelAdapter.ViewHolder holder);
    }
