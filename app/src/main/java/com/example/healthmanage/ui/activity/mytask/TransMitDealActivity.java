...
import com.example.healthmanage.databinding.ActivityTransmitDealBinding;
 ...
 * 转交处理
 */
public class TransMitDealActivity extends BaseActivity<ActivityTransmitDealBinding,MyNewTaskViewModel> implements TitleToolBar.OnTitleIconClickCallBack{
    ...
    protected void initData() {
        ...
        doctorAdapter = new DoctorAdapter(TransMitDealActivity.this,doctorBeans);
    ...
    protected void registerUIChangeEventObserver() {
        ...
        dataBinding.btnQueryPostDeal.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (transferId==null){
                    Toast.makeText(TransMitDealActivity.this,"请选择转交对象",Toast.LENGTH_SHORT).show();
                }else {
                    if (Integer.valueOf(transferId)== BaseApplication.getUserInfoBean().getAppDoctorInfo().getSystemUserId()){
                        ...
                        viewModel.sendTransferTask(id,Integer.valueOf(transferId));
                    }
        ...
        viewModel.isSendTransferSucceed.observe(this, new Observer<Boolean>() {
            ...
            public void onChanged(Boolean aBoolean) {
                if (aBoolean){
                    View view = View.inflate(TransMitDealActivity.this,R.layout.dialog_transmit_deal,null);
                    UIAlertDialog uiAlertDialog = new UIAlertDialog.DividerIOSBuilder(TransMitDealActivity.this)
                            .setView(view)
    ...
    protected int setContentViewSrc(Bundle savedInstanceState) {
        return R.layout.activity_transmit_deal;
    }
